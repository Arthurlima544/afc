...
- **Never push or open pull requests**: The user always opens PRs manually. Never call `git push` or `gh pr create` — just commit locally and inform the user the branch is ready.
