...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<CategoryEntity> categories)?  initial,TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( TransactionEntity transaction)?  success,TResult Function( List<TransactionEntity> transactions)?  listed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return success(_that.transaction);case _Listed() when listed != null:
return listed(_that.transactions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<CategoryEntity> categories)  initial,required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( TransactionEntity transaction)  success,required TResult Function( List<TransactionEntity> transactions)  listed,}) {final _that = this;
switch (_that) {
case _Initial():
return initial(_that.categories);case _Loading():
return loading();case _Error():
return error(_that.message);case _Success():
return success(_that.transaction);case _Listed():
return listed(_that.transactions);case _:
  throw StateError('Unexpected subclass');
...
class _Initial implements TransactionState {
  const _Initial(final  List<CategoryEntity> categories): _categories = categories;
...
@override
String toString() {
  return 'TransactionState.initial(categories: $categories)';
}
...
class _Success implements TransactionState {
  const _Success(this.transaction);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&(identical(other.transaction, transaction) || other.transaction == transaction));
}
...
class _Listed implements TransactionState {
  const _Listed(final  List<TransactionEntity> transactions): _transactions = transactions;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Listed&&const DeepCollectionEquality().equals(other._transactions, _transactions));
}
...
@override
String toString() {
  return 'TransactionState.listed(transactions: $transactions)';
}
...
/// @nodoc
abstract mixin class _$ListedCopyWith<$Res> implements $TransactionStateCopyWith<$Res> {
