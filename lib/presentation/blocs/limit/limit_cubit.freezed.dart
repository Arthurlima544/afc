...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LimitState);
}
...
/// @nodoc
class $LimitStateCopyWith<$Res>  {
$LimitStateCopyWith(LimitState _, $Res Function(LimitState) __);
}


/// Adds pattern-matching-related methods to [LimitState].
extension LimitStatePatterns on LimitState {
...
class _Initial implements LimitState {
...
@override
String toString() {
  return 'LimitState.initial(categories: $categories)';
}
...
/// @nodoc
abstract mixin class _$InitialCopyWith<$Res> implements $LimitStateCopyWith<$Res> {
...
class _Loading implements LimitState {
  const _Loading();
...
class _Error implements LimitState {
...
@override
String toString() {
  return 'LimitState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $LimitStateCopyWith<$Res> {
...
class _Success implements LimitState {
  const _Success(this.limit);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&(identical(other.limit, limit) || other.limit == limit));
}
...
@override
String toString() {
  return 'LimitState.success(limit: $limit)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $LimitStateCopyWith<$Res> {
...
$LimitEntityCopyWith<$Res> get limit;
...
$LimitEntityCopyWith<$Res> get limit {
  ...
  return $LimitEntityCopyWith<$Res>(_self.limit, (value) {
